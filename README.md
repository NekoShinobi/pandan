...
| **YouTube**        | Channel subscriptions organized by category, an Edit Sources menu for channel management and category ordering, a private Watch Later queue, mobile-friendly thumbnail or compact layouts, video actions in a three-dot menu, manual refresh, and shared metadata caching. |
