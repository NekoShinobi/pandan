...
- Heading erase and type budgets share one start time. Delayed frames consume both budgets, so page rendering cannot restart the typing budget after the transition should already have finished.
