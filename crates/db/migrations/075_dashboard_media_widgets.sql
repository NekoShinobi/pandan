-- Add media-backed dashboard widgets and keep their uploaded image bytes account-scoped.
...
CREATE TABLE dashboard_widgets_next (
    ...
    kind TEXT NOT NULL CHECK (kind IN (
        ...
        'section-header', 'divider', 'image-frame', 'music-visualizer',
...
CREATE TABLE dashboard_widget_images (
...
CREATE INDEX dashboard_widget_images_user_idx ON dashboard_widget_images (user_id);
